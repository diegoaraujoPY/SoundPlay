...
<html lang="pt-br">
	...
	<body style="background: #fff;">
					...
					<div class="container justify-content-center">
						<form method="POST" action="edit_music_lance.php" class="formulario">
							...
							while($postagem = mysqli_fetch_array($sql_query)){
								$nome = $postagem['nome'];
								$artista = $postagem['artista'];
								$descricao = $postagem['descricao'];
								$link = $postagem['link_musica'];
								$id_postagem = $postagem['id'];
							
						
								echo "<div class='mb-3'>";
								echo 	"<label for='titulo' class='form-label'>Nome da Música</label>";
								echo 	"<input type='text' class='form-control' name='nome' value='$nome' id='titulo' required>";
								echo "</div>";
								
								echo "<div class='mb-3'>";
								echo 	"<label for='titulo' class='form-label'>Artista</label>";
								echo 	"<input type='text' class='form-control' name='artista' value='$artista' id='titulo' required>";
								echo "</div>";
								...
								echo "<div class='mb-3'>";
								echo 	"<label for='link' class='form-label'>Link do Youtube</label>";
								echo 	"<input type='text' class='form-control' name='link' value='https://www.youtube.com/watch?v=$link' id='link' required>";
								echo "</div>";
								
								echo "<div class='col' style='float: right; padding: 10px;'>";
								echo 	"<input type='hidden' value='$id_postagem' name='id'/>";
								echo 	"<button type='submit' class='btn btn-success' required><i class='fa fa-floppy-o' aria-hidden='true'></i>Salvar</button>";
								echo "</div>";
								echo "<div class='col' style='float: right; padding: 10px;'>";
								echo 	"<a class='btn btn-danger' href='delete_music.php?id=$id_postagem'><i class='fa fa-trash' aria-hidden='true'></i>Excluir Música</a>";
								echo "</div>";
							}
