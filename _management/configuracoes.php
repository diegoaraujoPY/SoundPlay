...
<html lang="pt-br">
	...
	<body style="background: #fff;">
					...
					<div class="content justify-content-center">
							...
							<h1 style="padding: 40px; color: rgba(7,69,6,1);">Configurações do Usuário</h1>
							<a class='nav-link' href='dados_pessoais.php'>
							...
							<?php
								...
								if($nivel==1){
									echo "<a class='nav-link' href='administradores.php'>";
									echo 	"<ul class='nav justify-content-left postagens'>";
									echo 		"<span>Administradores</span>";
									echo 	"</ul>";
									echo "</a>";
								}
