...
<html lang="pt-br">
	...
	<body style="background: #fff;">
					...
					<div class="container justify-content-center">
						<form method="POST" action="add_playlist.php" class="formulario">
							<div class="mb-3">
							...
							<div class="mb-3">
							  <label for="playlist" class="form-label">Link da Playlist</label>
							  <input type="text" class="form-control" name="playlist" id="playlist" required>
							  <?php echo "<input type='hidden' class='form-control' name='id_classicas' value='$id' required>"; ?>
							</div>
