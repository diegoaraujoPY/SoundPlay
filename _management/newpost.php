...
<html lang="pt-br">
	...
	<body style="background: #fff;">
					...
					<div class="container justify-content-center">
						<form method="POST" action="addpost.php" class="formulario" enctype="multipart/form-data">
							<div class="mb-3">
							...
							<div class="mb-3">
							  ...
							  <textarea class="form-control" name="descricao" id="descricao" rows="14" required></textarea>
							</div>
							<div class="mb-3">
