...
<html lang="pt-br">
	...
	<body style="background: #fff;">
					...
					<div class="container justify-content-center">
						<form method="POST" action="add_music_year.php" class="formulario">
							<div class="mb-3">
							...
							<div class="mb-3">
								<label for="visualizacao" class="form-label">N°de visualizações</label>
								<input type="text" class="form-control" name="visualizacao" id="visualizacao" required>
							 </div>
