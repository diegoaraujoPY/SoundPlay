	...
	<body style="background: #fff;">
					...
					<div class="content justify-content-center">
						...
						<?php
							...
							$dvd_selecionado = mysqli_fetch_assoc($sql_query);
							
							$titulo = $dvd_selecionado['titulo'];
							$artista = $dvd_selecionado['artista'];
							
							echo "<h1 style='padding: 40px; color: rgba(7,69,6,1);'>$artista - $titulo</h1>";
							
							
							echo "<a class='nav-link' href='musics_dvd.php?id=$id''>";
							echo 	"<ul class='nav justify-content-left postagens'>";
							echo 		"<i class='fa fa-youtube-square' aria-hidden='true'></i><span>Músicas do DVD</span>";
							echo 	"</ul>";
							echo "</a>";
							echo "<a class='nav-link' href='config_dvd.php?id=$id'>";
							echo 	"<ul class='nav justify-content-left postagens'>";
