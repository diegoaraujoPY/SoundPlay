...
<html lang="pt-br">
	...
	<body style="background: #fff;">
					...
					<div class="content justify-content-center">
							<h1 style="padding: 40px; color: rgba(7,69,6,1);">Lançamentos <?php $anoatual = date('Y'); echo $anoatual;?></h1>
							<a class='nav-link' href='newpost.php'>
								<ul class="nav justify-content-left postagens">
									<i class="fa fa-plus" aria-hidden="true"></i><span>Nova postagem</span>
								</ul>
							</a>
							...
							<?php
								...
								if($quant>0){
									echo "<a class='nav-link' href='myposts.php'>";
									echo 	"<ul class='nav justify-content-left postagens'>";
									echo 		"<i class='fa fa-file' aria-hidden='true'></i><span>Postagens</span>";
									echo 	"</ul>";
									echo "</a>";
								}
