<?php
	...
	$_SESSION['id_editar_musica'] = $id_musica;
...
<html lang="pt-br">
	...
	<body style="background: #fff;">
					...
					<div class="container justify-content-center">
						<form method="POST" action="edit_music.php" class="formulario" enctype="multipart/form-data">
							...
							while($postagem = mysqli_fetch_array($sql_query)){
								...
								$link = $postagem['link_youtube'];
							
						
							echo "<div class='mb-3'>";
							echo 	"<label for='nome' class='form-label'>Nome da música</label>";
							echo 		"<input type='text' class='form-control' value='$nome' name='nome' id='nome' required>";
							echo "</div>";
							echo "<div class='mb-3'>";
							echo 	"<label for='artista' class='form-label'>Artista's/Banda</label>";
							echo 		"<input type='text' class='form-control' value='$artista' name='artista' id='artista' required>";
							echo "</div>";
							echo "<div class='mb-3'>";
							echo 	"<label for='link' class='form-label'>Link do video no Youtube</label>";
							echo 		"<input type='text' class='form-control' value='https://www.youtube.com/watch?v=$link' name='link' id='link' required>";
							echo "</div>";
