...
<html lang="pt-br">
	...
	<body style="background: #fff;">
					...
					<div class="container justify-content-center">
						<form method="POST" action="musics_dvd.php" class="formulario">
							<div class="mb-3">
							...
							<div class="mb-3">
							  <label for="local" class="form-label">Ano/Local</label>
							  <input type="text" class="form-control" name="local" id="local" required>
							</div>
							<div class="col" style="float: right;">
								<button type="submit" class="btn btn-primary" required>Avançar</button>
							</div>
						</form>
					</div>
